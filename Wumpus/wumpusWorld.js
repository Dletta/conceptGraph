...
posT.add(testSchema);
var testSchem = new axiomStore('schema');
var persSchema = parse('Create a new Person::[Person:**x](has?x?y)[Name:**y](has?x?z)[Body:**z](has?x?a)[Head:**a]');
testSchem.add(persSchema);
testReason.init(necT, posT, law, testNeg, testSchem);
