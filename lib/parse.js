  ...
  for(var result of ast) {
    ...
    for(var item of tree) {
      if(item[0].type === 'concept'){
        console.log(item[0]);
        temp.addConcept(item[0].label, item[0].type, uuidv4(), {}, item[0].ref, item[0].identifier, item[0].fuzzy);
      }
    }
...
var testInput = "John Goes::[Person:John*x(1.0)](Go?x?y)[Destination:Boston*y(1.0)]";
console.log(testInput);
var res2 = parse(testInput);
translate(res2);
