...
var thirdOne = parse('Third One Option::[Bird:Parrot*x](object?y?x)[Own:1*y](agent?z?y)[Owner:Celia*z](object?a?x)[Buy:4*a](pTime?a?b)[Month:March*b]');
puzzle.tell(thirdOne);
console.log('thirdTwo');
var thirdTwo = parse('Third One Option::[Bird:Parrot*x](object?y?x)[Own:1*y](agent?z?y)[Owner:Celia*z](object?a?x)[Buy:4*a](location?a?b)[City:Inyokern*b]');
