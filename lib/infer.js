...
function InfOp (graph, axioms, mode, stateLabel) {
  ...
  * @param rule (boolean) - switch mode
  */
  this.extendGraph = function (target, source, rule) { // <-- rework this extension
...
var init1 = parse('Init One::[Owner:**x](agent?x?y)[Own:1*y](object?y?z)[Bird:**z](object?c?z)[Buy:1*c](pTime?c?a)[Month:**a](location?c?b)[City:**b]');
canon.add(init1);
var init2 = parse('Init Two::[Owner:**d](agent?d?e)[Own:2*e](object?e?f)[Bird:**f](object?g?f)[Buy:2*g](pTime?g?h)[Month:**h](location?g?i)[City:**i]');
canon.add(init2);
var init3 = parse('Init Three::[Owner:**j](agent?j?k)[Own:3*k](object?k?l)[Bird:**l](object?m?l)[Buy:3*m](pTime?m?n)[Month:**n](location?m?o)[City:**o]');
canon.add(init3);
var init4 = parse('Init Four::[Owner:**p](agent?p?q)[Own:4*q](object?q?r)[Bird:**r](object?s?r)[Buy:4*s](pTime?s?t)[Month:**t](location?s?u)[City:**u]');
canon.add(init4);
var init5 = parse('Init Five::[Owner:**v](agent?v?w)[Own:5*w](object?w?X)[Bird:**X](object?Y?X)[Buy:5*Y](pTime?Y?Z)[Month:**Z](location?Y?A)[City:**A]');
canon.add(init5);
