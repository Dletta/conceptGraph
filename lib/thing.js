...
function Thing (label, type, uuid, arcs, value) {
  ...
  this.addConcept = function (label, type, uuid, arcs, value) {
    ...
    var item = new Thing(label, type, uuid, arcs, value);
    } else {
    var item = label;
    }
  ...
  this.addConConcept = function (label, type, uuid, arcs, value) {
    if(typeof label == 'string') {
    var item = new Thing(label, type, uuid, arcs, value);
    } else {
    var item = label;
  ...
  this.addConRelation = function (label, type, uuid, arcs, value) {
    if(typeof label == 'string') {
    var item = new Thing(label, type, uuid, arcs, value);
    } else {
    var item = label;
